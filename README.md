...
* 📄 **[Hivatalos Vizsga Dokumentáció](./Vegso_Dokumentumok/vizsga%20dokumentacio%20(1).docx)** - *A projekt részletes logikai és hálózatépítési terve.*
* 📋 **[Tesztelési Dokumentáció](./Vegso_Dokumentumok/Tesztelesi%20Dokumentacio.docx)** - *A hálózat működésének, a ping teszteknek és a biztonsági beállításoknak az ellenőrzése.*
...
1. A hálózati szimulációk futtatásához töltsd le azt a fájlt amire szükséged van a **[Packet_Tracer](./PKT)** mappából.
2. A megnyitáshoz legalább **Cisco Packet Tracer 8.x** verzió szükséges.
3. Az eszközök részletes beállításai a **[Konfiguraciok](./Konfigok)** mappában lévő szöveges fájlokban olvashatóak vissza.
